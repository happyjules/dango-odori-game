...
function square(){
    ...
    // pushes square vertices and texture coordinates
    this.quad = function(a, b, c, d) {
        this.points.push(squareVertices[a]);
        this.points.push(squareVertices[b]);
        this.points.push(squareVertices[c]);

        this.points.push(squareVertices[a]);
        this.points.push(squareVertices[c]);
        this.points.push(squareVertices[d]);
    }
    this.setTexture = function(){
        this.texCoordsArray.push(texCoord[3]);
        this.texCoordsArray.push(texCoord[2]);
    ...
    this.init_buffers = ( function (self) {
        ...
        self.image = document.getElementById("instr");
    //     image.onload = function(){
        self.texture = gl.createTexture();
        gl.bindTexture( gl.TEXTURE_2D, self.texture );
